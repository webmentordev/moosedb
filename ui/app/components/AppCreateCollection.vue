            ...
            <div class="w-137.5 h-full border-l border-white/10 bg-light p-6 overflow-y-auto">
                ...
                <div class="mt-3">
                    ...
                    <div class="p-3 bg-dark rounded-lg mt-4 grid grid-cols-3 gap-3" v-show="dropdown">
                        <button @click="addField(column)" v-for="column in columns" :key="column.id"
                        ...
                        <div v-for="(field, index) in fields" :key="index"
                            ...
                            <div class="space-y-3">
                                <div class="flex flex-col">
                                    ...
                                    <AppInput v-model="field.title" type="text" placeholder='e.g title, author, isbn' />
                                </div>
                                ...
                                <div v-if="field.type === 'INTEGER' || field.type === 'DECIMAL'"
                                ...
                                <div v-if="field.type === 'FILE'" class="flex flex-col">
                                    ...
                                    <AppInput v-model="field.allowedExtensions" type="text"
                    ...
                    <p class="mt-2 text-sm">
                        <code>id (auto increment)</code>, <code>created_at</code> and <code>updated_at</code> will be
                        auto generated.
                    </p>
                    <button @click="createCollection" :disabled="loading"
